 ...
 * 1. start a loop with condition low<high
...
public class MoveZeros {
    ...
    //{4,2,4,0,0,3,0,5,1,0}
    //after 1st iteration - //{4,2,4,0,0,3,0,5,1,0} //lowV=2//highV=1
    //so on - //{4,2,4,0,0,3,0,5,1,0} //lowV=4//highV=1
    //so on - //{4,2,4,0,0,3,0,5,1,0} //lowV=0//highV=1
    //so on - //{4,2,4,1,0,3,0,5,0,0} //lowV=0//highV=5
    //so on - //{4,2,4,1,5,3,0,0,0,0} //lowV=3//highV=0
    private static int[] moveZerosToEnd(int[] arr) {
        ...
        while (low < high) {
            ...
            if (lowValue == 0 && highValue != 0) {
                //mark flag for letting know that zero exist in the array
                isZeroExist = true;
                //swap
        ...
        while (isZeroExist && high<arr.length && arr[high] != 0) {
            //swap
